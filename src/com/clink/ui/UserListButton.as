package com.clink.ui
{
	 ...
	 * 
	 */	
	public class UserListButton extends Base_componentToolTip
	{
		 ...
		 * 
		 */		
		public function UserListButton(width:Number,height:Number,isRollOver:Boolean = false)
		{
			super();
			...
			if(!_buttonList)
			{
				throw new Error("Please initialize this class by calling UserListButton.init() at the beginning of your application");
			}
		...
		public function toggle():void
		{
			...
			if(_toggleGroup && _toggleGroup.length > 0)
			{
				for each(var b:UserListButton in _toggleGroup)
				{
					if(b != this)
					{
						b.up();
		...
		{
			for each(var b:UserListButton in _buttonList)
			{
				b.redraw();
			}
		}
