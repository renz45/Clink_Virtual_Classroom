package com.clink.ui
{
	...
	public class ScrollList extends Sprite
	{
		...
		private var _container:LayoutBox;
		 ...
		 * 
		 */		
		public function ScrollList(width:Number,height:Number,bgColor:String = null)
		{
			super();
		 ...
		 * 
		 */		
		public function addListItem(item:DisplayObject):void
		{
